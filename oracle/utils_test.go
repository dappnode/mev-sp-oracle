...
func Test_DecodeTx(t *testing.T) {
	...
	sender, err := GetTxSender(tx1)
	require.Equal(t, tx1.To().String(), "0x388C818CA8B9251b393131C08a736A67ccB19297")
	require.Equal(t, sender.String(), "0xbd3Afb0bB76683eCb4225F9DBc91f998713C3b01")
	...
	require.Equal(t, sender2.String(), "0xDAFEA492D9c6733ae3d56b7Ed1ADB60692c98Bc5")
	...
	require.Equal(t, sender3.String(), "0xaF8162eaE1253ea5Ce016B9DF1EA779993dFb826")
}
