...
func Test_Bellatrix_TxType_0_Decode(t *testing.T) {
	...
	require.Equal(t, "0xbd3Afb0bB76683eCb4225F9DBc91f998713C3b01", sender.String())
...
func Test_Bellatrix_TxType_2_Decode(t *testing.T) {
	...
	require.Equal(t, "0xDAFEA492D9c6733ae3d56b7Ed1ADB60692c98Bc5", sender.String())
...
func Test_Bellatrix_TxType2WithERC20_Decode(t *testing.T) {
	...
	require.Equal(t, "0xaF8162eaE1253ea5Ce016B9DF1EA779993dFb826", sender.String())
